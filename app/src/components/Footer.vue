  ...
  <footer class="transition-colors duration-300">
    <div class="container mx-auto px-4 py-16 md:py-24 text-center">
      ...
      <div class="flex justify-center space-x-6 mb-12">
        <a href="#" aria-label="LinkedIn" class="text-secondary-light dark:text-secondary-dark hover:text-accent-primary-light dark:hover:text-accent-primary-dark transition-colors duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
        </a>
        <a href="#" aria-label="Twitter" class="text-secondary-light dark:text-secondary-dark hover:text-accent-primary-light dark:hover:text-accent-primary-dark transition-colors duration-300">
        ...
        <a href="#" aria-label="YouTube" class="text-secondary-light dark:text-secondary-dark hover:text-accent-primary-light dark:hover:text-accent-primary-dark transition-colors duration-300">
      ...
      <div class="pt-8">
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div class="flex space-x-4">
            <router-link to="/politica-de-privacidad" class="text-base text-secondary-light dark:text-secondary-dark hover:text-accent-primary-light dark:hover:text-accent-primary-dark transition-colors">Política de Privacidad</router-link>
            <router-link to="/politica-de-cookies" class="text-base text-secondary-light dark:text-secondary-dark hover:text-accent-primary-light dark:hover:text-accent-primary-dark transition-colors">Política de Cookies</router-link>
          </div>
        </div>
      </div>
